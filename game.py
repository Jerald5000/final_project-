...
points_label = Label('Points: 0', font_name='Arial', font_size=18,x=10, y=window_height-30)
...
health = 100
health_label = Label(f'Health: {health}', font_name='Jonkeith', font_size=18, x=625, y=window_height-30)
